...
def cornerHeuristic(player, gameBoard):
    ...
    for corner in OthelloRefined.corners():
        piece = gameBoard[corner]
        if piece == player:
            playerCornersHeld += 1
        elif piece == OthelloRefined.getOpponent(player):
            opponentCornersHeld += 1
        elif corner in OthelloRefined.legalMovesRefined(player, gameBoard):
            playerCornersPossible += 1
        elif corner in OthelloRefined.legalMovesRefined(OthelloRefined.getOpponent(player), gameBoard):
